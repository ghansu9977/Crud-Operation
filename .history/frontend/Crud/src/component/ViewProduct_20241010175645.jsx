            ...
            {!loading && !error && (
                <>
                    ...
                    <div className='d-flex justify-content-between align-items-center mb-3'>
                        ...
                        <Button variant="contained" color="default" onClick={UploadExcel} style={{ marginLeft: "-494px" }}>
                                ...
                                {currentItems.map((item) => (
                                    <TableRow key={item._id}>
                                        ...
                                        <TableCell align="center">
                                            <Button variant="contained" color="primary" className="me-1" onClick={() => navigate(`/view-product/${item._id}`)}>
